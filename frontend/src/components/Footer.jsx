    ...
    <div className="text-bg-light mt-3">
      <div className="col-12 mx-auto p-4 d-flex flex-column">
        ...
        <div className="col-12 col-md-10 col-lg-11 mx-auto d-flex flex-wrap gap-4 my-4">
          {/* Social */}
          <div className="flex-fill d-flex text-center justify-content-around rounded-4 p-4 custom-card shadow">
            ...
            <Link
              ...
              target="_blank"
            >
              <i className="bi bi-linkedin h1"></i>
            </Link>
            <Link to={"https://laghazala.tn/"} target="_blank">
              <i className="bi bi-globe-europe-africa h1"></i>{" "}
            </Link>
          </div>

          {/* Phone */}
          <div className="flex-fill d-flex text-center justify-content-around rounded-4 p-4 custom-card shadow">
            <i className="bi bi-telephone-outbound h1 m-0"></i>
